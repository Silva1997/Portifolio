...
import { Flex, Anchor, ConfigProvider } from 'antd';
...
import iconLandpage from './assets/landpage.png'
export default function App() {
  ...
  const servicos = [
    {
      icon: <img width={80} src={iconUx} alt="Icon UX" />, // Adicione alt para acessibilidade
    ...
    {
      icon: <img width={80} src={iconApp} alt="Icon App" />, // Adicione alt para acessibilidade
      title: 'Desenvolvimento Aplicação Web',
      description: 'Criação de Aplicativos web e móveis para todo tipo de serviços.',
      delay: 0.05,
    },
    {
      icon: <img width={80} src={iconLandpage} alt="Icon Landpage" />, // Adicione alt para acessibilidade
      title: 'Desenvolvimento Landing Pages',
  ...
  return (
    <>
      ...
      <nav className="  shadow-sm shadow-red-500/50 overflow-hidden xl:text-white sticky top-0 z-[1000] items-center text-center h-16 pt-4 pb-4 bg-slate-950 flex flex-row justify-end xl:pl-14 xl:pr-16">
        ...
        <div className=' sm:relative sm:right-80  xl:text-start xs-min:relative xl:relative xs-min:right-48 xl:right-[22.6rem]'>
      ...
      <main className=" overflow-hidden xl:text-white flex flex-col xs-min:mr-6 xs-min:ml-6 md:mr-16 md:ml-16 xl:xl:mr-48 xl:ml-48 ">
        ...
        <div id='index'>
          ...
          <p className=" xs-min:text-wrap sm:text-xl xs-min:text-[1.19rem]  md:text-2xl xl:text-2xl  xs-min:text-justify tracking-normal xl:text-justify text-gray-400" >
            Sou engenheiro de informática de gestão especializado em criar
          ...
          <a className=" xs-min:text-white xl:text-white xs-min:mt-2  xl:fixed xl:top-[24rem] xl:-right-8 hover:text-red-500  xl:text-sm  xl:rotate-90 cursor-pointer"><span className='flex items-center gap-2 text-sm hover:scale-110' ><FiSend />Lucaseugeniofernando@gmail.com</span></a>
        ...
        <Projectos ref={ref} inView={inView} />
        ...
        <div id='contacto'>
          ...
          >
            <h1 className=" font-fontjetbrains font-normal text-gray-300 xs-min:text-xl xs-min:font-semibold xl:text-2xl  font-fira">
              <span className=" xl:text-2xl xs-min:text-red-500 xl:text-red-500 font-jetbrains font-bold">
                05.
              </span>Contacto</h1> <hr className=" xs-min:w-32 xl:w-56 font-bold  xl:mt-3 ml-4" />
          </motion.h1>
          ...
          <form onSubmit={handleObter} className='flex justify-center flex-col items-center gap-4 xs-min:p-0.5 xs-min:mb-24 xl:mb-32 mt-4' >
            <input type='text' onChange={handleChange} name='nome' className=' xs-min:w-[100%] xs-min:text-white xl:w-[80%] h-12 bg-transparent border-[1px] border-gray-500 xl:text-white' placeholder='Nome' />
            <input type='email' onChange={handleChange} name='email' className=' xs-min:w-[100%] xs-min:text-white xl:w-[80%] h-12 bg-transparent border-[1px] border-gray-500 xl:text-white' placeholder='Email' />
            <textarea onChange={handleChange} name='textoarea'   className=' xs-min:w-[100%] xs-min:text-white xl:w-[80%] bg-transparent border-[1px] border-gray-500 xl:text-white'
            ...
            <button type='reset' className=' xs-min:w-56 xl:w-96 text-white h-12 border-[1px] border-red-500 bg-transparent hover:bg-red-500/50'>Limpar</button>
...
function Projectos({ ref, inView }) {
  ...
  return (
    ...
    <div id='projectos'>
      ...
      >
        <h1 className=" font-fontjetbrains font-normal xs-min:mt-6 text-gray-300 xs-min:text-xl xs-min:font-semibold xl:text-2xl  font-fira">
          <span className="xl:text-2xl xs-min:text-red-500  xl:text-red-500 font-jetbrains font-bold">04. </span>
          Projectos</h1> <hr className=" xs-min:w-36 xl:w-56 xs-min:mt-7 font-bold xl:mt-3 ml-4" />
      </motion.h1>
      <div className="grid xs-min:mt-2 text-white
      xs-min:p-3 xs-min:mb-8 xs-min:grid-cols-1 
      sm:grid-cols-2 md:grid-cols-2 xl:mt-8 xl:mb-8
       xl:p-2 xl:grid-cols-3 place-items-center gap-4">
        ...
        <motion.div
          className='hover:duration-75 xl:hover:scale-105 
              ...
              flex flex-col items-center justify-center  w-full xs-min:h-96 xl:h-64 rounded-md'
        // ref={ref}
        // initial={{ opacity: 0, y: 50 }}
        // animate={inView ? { opacity: 1, y: 0 } : {}}
        ...
        >
          ...
          <h5 className='font-bold'>Netflix Angola</h5>
          <p className='text-center text-base'>
            Projecto de um website de pagamento de nextflix visa Kwanza.
          </p>
        ...
        >
          ...
          <p className='text-center text-base'>
            Criação de uma landpage para agendamento em um salão de beleza.
          </p>
        ...
        >
          ...
          <h5 className='font-bold'>Portal de emprego</h5>
          <p className='text-center text-base'>
            Criação de um portal de emprego para jovens a procura de uma oportunidade
          </p>
...
function Navegador() {
  ...
  return (
    ...
    <div className='   md:flex md:flex-row md:items-center md:gap-3 xs-min:hidden xl:flex xl:flex-row xl:items-center xl:w-[43rem] xl:gap-3'>
      ...
      >
        <Anchor
          className='mt-1 text-white flex items-center  relative md:right-4  xl:right-[4rem] w-[46.9rem]'
          ...
          items={[
...

            {
              key: 'part-4',
              href: '#projectos',
              title: <h6 className=" xl:font-fontjetbrains xl:font-normal text-white  text-base  font-semibold  hover:text-red-500  cursor-pointer">  <span className="text-red-500 ">04.</span> Projectos</h6>

            },
            {
              key: 'part-5',
              href: '#contacto',
              title: <h6 className=" xl:font-fontjetbrains xl:font-normal text-white  text-base  font-semibold  hover:text-red-500  cursor-pointer">  <span className="text-red-500 ">05.</span> Contacto</h6>
...

            {
              key: 'part-6',
              href: '#',
              title: <button className=" xl:font-fontjetbrains xl:font-normal  hover:bg-red-500/40 xl:p-2   hover:text-white md:text-red-500 xl:text-red-500 border-[2px] h-10 border-red-600 rounded-sm md:w-24   xl:w-full ">
...
const Barras = () => (
  <Flex gap="small" vertical
    ...
    <div className='flex xs-min:justify-center xs-min:flex-col xs-min:items-start xs-min:gap-2 xl:gap-6 xl:justify-start xl:items-center xl:flex-row'>
      ...
      <div class="flex xs-min:w-56 xl:w-96 border-none  h-5/6 overflow-hidden font-sans text-xs font-medium  flex-start bg-white">
    ...
    <div className='flex xs-min:justify-center xs-min:flex-col xs-min:items-start xs-min:gap-2 xl:gap-6 xl:justify-start xl:items-center xl:flex-row'>
      ...
      <div class="flex xs-min:w-56  xl:w-96 h-5 overflow-hidden font-sans text-xs font-medium  flex-start bg-white">
    ...
    <div className='flex xs-min:justify-center xs-min:flex-col xs-min:items-start xs-min:gap-2 xl:gap-5 xl:justify-start xl:items-center xl:flex-row'>
      <h5 className='xl:text-white'>TAILWINDCSS</h5>
      <div class="flex xs-min:w-48
    xl:w-80  h-5 overflow-hidden 
    font-sans 
    text-xs font-medium  
    flex-start bg-white">
    ...
    <div className='flex xs-min:justify-center xs-min:flex-col xs-min:items-start xs-min:gap-2 xl:gap-[3.6rem] xl:justify-start xl:items-center xl:flex-row'>

      <h5 className='xl:text-white'>GITHUB</h5>

      <div class="flex xl:w-80 border-none xs-min:w-48 h-5/6 overflow-hidden font-sans text-xs font-medium  flex-start bg-white">
    ...
    <div className='flex xs-min:justify-center xs-min:flex-col xs-min:items-start xs-min:gap-2 xl:gap-8 xl:justify-start xl:items-center xl:flex-row'>

      <h5 className='xl:text-white'>JAVASCRIPT</h5>
      <div class="flex  xs-min:w-[10rem] xl:w-80  border-none h-5/6 overflow-hidden font-sans text-xs font-medium  flex-start bg-white">
